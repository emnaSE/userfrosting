let browserifyDependencies,Bundler,MergeRawConfigs,ValidateRawConfig,mergeBowerDeps,mergeNpmDeps,childProcess,_exec,deleteSync,envConfig,existsSync,readFileSync,writeFileSync,gulp,minifyCss,concatJs,concatCss,prune,rev,minifyJs,info,resolvePath,stripAnsi,promisify;_98c‍.x([["assetsInstall",()=>assetsInstall],["bundle",()=>bundle],["frontend",()=>frontend],["clean",()=>clean]]);_98c‍.w("@userfrosting/browserify-dependencies",[["default",["browserifyDependencies"],function(v){browserifyDependencies=v}]]);_98c‍.w("@userfrosting/gulp-bundle-assets",[["default",["Bundler"],function(v){Bundler=v}],["MergeRawConfigs",["MergeRawConfigs"],function(v){MergeRawConfigs=v}],["ValidateRawConfig",["ValidateRawConfig"],function(v){ValidateRawConfig=v}]]);_98c‍.w("@userfrosting/merge-package-dependencies",[["bower",["mergeBowerDeps"],function(v){mergeBowerDeps=v}],["npm",["mergeNpmDeps"],function(v){mergeNpmDeps=v}]]);_98c‍.w("child_process",[["default",["childProcess"],function(v){childProcess=v}],["exec",["_exec"],function(v){_exec=v}]]);_98c‍.w("del",[["sync",["deleteSync"],function(v){deleteSync=v}]]);_98c‍.w("dotenv",[["config",["envConfig"],function(v){envConfig=v}]]);_98c‍.w("fs",[["existsSync",["existsSync"],function(v){existsSync=v}],["readFileSync",["readFileSync"],function(v){readFileSync=v}],["writeFileSync",["writeFileSync"],function(v){writeFileSync=v}]]);_98c‍.w("gulp",[["default",["gulp"],function(v){gulp=v}]]);_98c‍.w("gulp-clean-css",[["default",["minifyCss"],function(v){minifyCss=v}]]);_98c‍.w("gulp-concat",[["default",["concatJs"],function(v){concatJs=v}]]);_98c‍.w("gulp-concat-css",[["default",["concatCss"],function(v){concatCss=v}]]);_98c‍.w("gulp-prune",[["default",["prune"],function(v){prune=v}]]);_98c‍.w("gulp-rev",[["default",["rev"],function(v){rev=v}]]);_98c‍.w("gulp-uglify-es",[["default",["minifyJs"],function(v){minifyJs=v}]]);_98c‍.w("gulplog",[["info",["info"],function(v){info=v}]]);_98c‍.w("path",[["resolve",["resolvePath"],function(v){resolvePath=v}]]);_98c‍.w("strip-ansi",[["default",["stripAnsi"],function(v){stripAnsi=v}]]);_98c‍.w("util",[["promisify",["promisify"],function(v){promisify=v}]]);
 ...
 */
       const frontend = gulp.series(assetsInstall, bundle);
