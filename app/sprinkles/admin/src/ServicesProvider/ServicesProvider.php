...
class ServicesProvider
{
    ...
    public function register(ContainerInterface $container)
    {
        ...
        $container->extend('classMapper', function ($classMapper, $c) {
            ...
            $classMapper->setClassMapping('transaction_sprunje', 'UserFrosting\Sprinkle\Admin\Sprunje\TransactionsSprunje');
            $classMapper->setClassMapping('order_sprunje', 'UserFrosting\Sprinkle\Admin\Sprunje\OrderSprunje');
            return $classMapper;
        });
