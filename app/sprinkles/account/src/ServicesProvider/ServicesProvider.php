...
class ServicesProvider
{
    ...
    public function register(ContainerInterface $container)
    {
        ...
        $container->extend('classMapper', function ($classMapper, $c) {
            ...
            $classMapper->setClassMapping('transaction', 'UserFrosting\Sprinkle\Account\Database\Models\Transaction');
            $classMapper->setClassMapping('order', 'UserFrosting\Sprinkle\Account\Database\Models\Order');
